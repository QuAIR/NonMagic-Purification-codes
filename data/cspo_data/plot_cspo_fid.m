...
plot(p_list, f_cspo_01, '-', 'Color', color_p01, 'LineWidth', lw, ...
    'Marker', 'o', 'MarkerIndices', mk_idx, 'MarkerSize', ms, ...
    'DisplayName', '$\mathcal{A}_{\mathrm{CSPO}} (p=0.1)$');
hold on
...
print(gcf, '-dsvg', '-vector', 'fid_cspo_01.svg');
...
plot(p_list, f_cspo_06, '-', 'Color', color_p06, 'LineWidth', lw, ...
    'Marker', 'o', 'MarkerIndices', mk_idx, 'MarkerSize', ms, ...
    'DisplayName', '$\mathcal{A}_{\mathrm{CSPO}} (p=0.6)$');
hold on
...
print(gcf, '-dsvg', '-vector', 'fid_cspo_06.svg');
